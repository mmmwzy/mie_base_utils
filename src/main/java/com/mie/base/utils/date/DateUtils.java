package com.mie.base.utils.date;
...
public class DateUtils {
    ...
    public static String DATE_TIMENOS_FORMAT = "yyyy-MM-dd HH:mm";
     ...
     *
     */
    public static String getCurrentDateTimeNoS() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(DateUtils.DATE_TIMENOS_FORMAT);
        datestr = df.format(new Date());
        return datestr;
    }
    ...
    public static void main(String[] args) {
        //String temp = DateUtils.dateToString(getLastDayOfMonth(new Date()),
        ///   DateUtils.DATE_FORMAT_CHINESE);
        //String s=DateUtils.dateToString(DateUtils.addDay(DateUtils.addYear(new Date(),1),-1));
